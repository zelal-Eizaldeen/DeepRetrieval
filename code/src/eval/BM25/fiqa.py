...
if not os.path.exists("data/local_index_search/fiqa/pyserini_index"):
    print("[Warning] Pyserini index not found for fiqa")
    search_system = None
else:
    search_system = PyseriniMultiFieldSearch(index_dir="data/local_index_search/fiqa/pyserini_index")


if __name__ == '__main__':
    with open("data/raw_data/fiqa/qrels/test.tsv", "r", encoding="utf-8") as file:
    ...
    with open("data/raw_data/fiqa/queries.jsonl", "r", encoding="utf-8") as file:
