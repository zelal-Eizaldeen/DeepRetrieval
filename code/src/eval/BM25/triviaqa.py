...
def main():
    ...
    parser.add_argument("--model_path", type=str, default="/shared/eng/pj20/lmr_model/triviaqa_3b/actor/global_step_400")
    parser.add_argument("--data_path", type=str, default="data/local_index_search/triviaqa/test.parquet")
    parser.add_argument("--model_name", type=str, default="tqa-3b-step-400")
