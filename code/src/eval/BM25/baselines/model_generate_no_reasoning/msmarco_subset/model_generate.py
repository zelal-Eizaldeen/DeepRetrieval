...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="code/data/local_index_search/no_reason/msmarco_science/sparse/test.parquet")
    parser.add_argument("--model_name", type=str, default="Qwen-inst-msmarco_science")
