...
if __name__ == '__main__':
    ...
    # res_dir = '../results/gpt-4o_post_msmarco_beir.json'
    ...
    # res_dir = '../results/no_reason/claude-haiku_post_msmarco_beir.json'
    res_dir = '../results/claude-haiku_post_msmarco_beir.json'
