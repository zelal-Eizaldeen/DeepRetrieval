...
index_path = 'data/local_index_search/nfcorpus/dense_index/faiss-flat.beir-v1.0.0-nfcorpus.bge-base-en-v1.5.20240107'
model_name = 'BAAI/bge-base-en-v1.5'

if not os.path.exists(index_path):
    print("[Warning] Faiss index not found for nfcorpus")
    search_system = None
else:
...
if __name__ == '__main__':
    ...
    # res_dir = '../results_dense/no_reason/gpt-35_post_nfcorpus.json'
    # res_dir = '../results_dense/gpt-35_post_nfcorpus.json'
    # res_dir = '../results_dense/no_reason/claude-haiku_post_nfcorpus.json'
    res_dir = '../results_dense/claude-haiku_post_nfcorpus.json'
