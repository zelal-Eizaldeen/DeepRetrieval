...
def load_matching_dataset():
    ...
    with open('data/raw_data/triviaqa/train.jsonl', 'r') as f:
        for line in f:
            data_train.append(json.loads(line))

    with open('data/raw_data/triviaqa/test.jsonl', 'r') as f:
        for line in f:
            data_test.append(json.loads(line))
            
    with open('data/raw_data/triviaqa/dev.jsonl', 'r') as f:
        cnt = 0
        for line in f:
