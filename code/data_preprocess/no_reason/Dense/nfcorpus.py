...
INSTRUCTION = """
You are an expert in generating queries for dense retrieval. Given a question, your task is to retain the original query while expanding it with additional semantically relevant information, to retrieve relevant documents that best answer the question. If no useful expansion is needed, return the original query as is."""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='code/data/local_index_search/no_reason/Dense/nfcorpus')
