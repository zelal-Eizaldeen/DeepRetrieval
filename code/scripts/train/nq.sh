...
python3 -m verl.trainer.main_ppo \
    data.train_files=data/local_index_search/nq/train.parquet \
    data.val_files=data/local_index_search/nq/val.parquet \
    ...
    trainer.default_local_dir=/shared/eng/pj20/lmr_model/nq_3b \
